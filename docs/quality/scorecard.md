...
| PR 리뷰 게이트 | 없음 -> 도입 | Gemini review activity, requested changes, unresolved thread, CI 상태를 merge 전 검증함 |
| PR 자동 완료 | 없음 -> 도입 | PR 생성 후 Gemini review를 기다리고 gate 통과 시 merge/cleanup까지 수행함 |
