...
- Auto-finish cleanup. Remote feature branch deletion must bypass local push hooks only for cleanup, and feature worktree removal must handle initialized submodules without deleting dirty or locked worktrees.
