...
- Auto-finish cleanup. After merge, remote feature branch deletion must bypass local push hooks only for cleanup, and feature worktree removal must handle initialized submodules.
