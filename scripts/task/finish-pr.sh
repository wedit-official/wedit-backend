...
usage() {
  cat >&2 <<'EOF'
usage: finish-pr.sh [--resolve-threads] [pr-number|pr-url|branch]

Merges a verified PR, updates the local develop worktree, removes the feature
worktree, and deletes the local feature branch.
